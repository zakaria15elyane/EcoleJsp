...
public class ModelAuthentification {
    ...
    public ModelAuthentification() {
    }

    public ModelAuthentification(int id, String nom, String prenom, String email, String nom_de_utilisateur, String mod_de_passe, int etat, String role, String telephone) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
